...
This example demonstrates how to use the Anthropic (Claude) provider with the go-agentkit. It creates a simple calculator agent that can perform basic arithmetic operations using Claude's tool use capability.
